...
const Home = () => {
  const slides = [
    {
      image: "/assets/slide 1.jpg", // Correct reference for the 'public' directory
      title: "Welcome to DineFlow",
      description: "Simplify your restaurant management with DineFlow.",
    },
    {
      image: "/assets/slide 2.jpg", // Correct reference for the 'public' directory
      title: "Discover Culinary Excellence",
      description:
        "Streamline operations and enhance customer satisfaction with DineFlow.",
    },
    {
      image: "/assets/slide 3.jpg", // Correct reference for the 'public' directory
